...
Mỗi video sẽ được theo dõi riêng. Khi một video xuất hiện trong vùng nhìn thấy của màn hình (viewport) và đạt ít nhất 80% diện tích hiển thị, video sẽ tự động phát. Khi người dùng cuộn sang video khác và video hiện tại không còn hiển thị đủ 80% (threshold:0.8), video sẽ tự động tạm dừng.
